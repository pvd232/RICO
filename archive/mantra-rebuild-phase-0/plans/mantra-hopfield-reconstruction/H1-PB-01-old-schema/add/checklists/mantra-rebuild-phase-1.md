# MANTRA Rebuild Phase 1

This checklist tracks the Hopfield reconstruction from the trusted Phase 0
result through preprocessing, encoder training, exact output parity, and
terminal provenance registration. Status is derived from the current contract,
...
|---|---|---|---|---|
| <nobr><code>H1-PB-01</code></nobr> | drafting | [mantra-hopfield-reconstruction](../contracts/mantra-hopfield-reconstruction.md#h1-pb-01) | None | None |
