...
**Derived progress:** in_progress

### Requirements

| Requirement | Claim | Progress | Verifiers | PairBlocks |
|---|---|---|---|---|
| <nobr><code>H1-REQ-01</code></nobr> | Phase 1 must begin from the selected Phase 0 Hopfield prediction SHA-256 d7180c4669a11b0b2fb184814aafb48ebafe75b02e4bd07998c337aa64dc59b7 and hold PearsonDelta 0.5861640938949398. | in_progress | <nobr><code>H1-VR-01</code></nobr> | <nobr><code>H1-PB-01</code></nobr> |
| <nobr><code>H1-REQ-02</code></nobr> | Every reconstructed array must retain its row identities, gene axis, fitting population, shape, dtype, and normalization population. | planned | <nobr><code>H1-VR-02</code></nobr> | <nobr><code>H1-PB-02</code></nobr> |
...
**Objective:** Install the typed Phase 1 contract and checklist workspace and bind them to the trusted Phase 0 Hopfield result.
...
**Objective:** Implement the row, gene, fitting-population, shape, dtype, and normalization identity boundary.
...
**Objective:** Rebuild and compare the selected preprocessing artifacts in producer order.
...
**Objective:** Train and select the historical Hopfield encoder through an identity-bound VIPER run.
...
**Objective:** Rebuild raw-gene retrieval and reference correction and prove exact final output parity.
...
**Objective:** Register the complete Phase 1 provenance graph and close the reconstruction checklist.
