...
| <nobr><code>E0-VR-12</code></nobr> | <nobr><code>E0-REQ-12</code></nobr> | The live worker probe records every declared execution-identity field through VIPER before training, confirms the canonical workspace and durable destination are writable, and rejects a resume after any unreviewed source, plan, configuration, command, input, seed, RNG state, environment, runtime, accelerator, device, dtype, workspace, or destination change. | [test_records_complete_live_worker_identity](../../mantra/src/mantra/rebuild/tests/test_gpu_launch_probe.py) | [test_rejects_changed_or_incomplete_worker_identity](../../mantra/src/mantra/rebuild/tests/test_gpu_launch_probe.py) |
