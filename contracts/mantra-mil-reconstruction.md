...
**Dependencies:** <nobr><code>H1-PB-08</code></nobr>
...
**Requirement contribution:** Rebuild and compare the complete MIL training-input bundle, bags, priors, and conditioning arrays.
...
| <nobr><code>M2-REQ-02</code></nobr> | The selected MIL descriptor rows, coefficient and gene targets, control shift, cell-program projections, matched cell programs, teacher bags, attention priors, and conditioning arrays must be rebuilt and compared with their historical counterparts before training. | planned | <nobr><code>M2-VR-02</code></nobr> | <nobr><code>M2-PB-02</code></nobr> |
...
| <nobr><code>M2-REQ-04</code></nobr> | The selected Step02 covariance shrinkage, teacher-neighbor smoothing, and retrieval path must reproduce prediction SHA-256 c0011d71436c540bde8dd00f9e2f8ac8fb46aa787161460a1aefce5f0f1277be, weight SHA-256 8290145991446afd9f45c3f3be1ad7fe95518dfe6f75e1e950b86a2b84c323ab, and hold PearsonDelta 0.5924883417873266. | planned | <nobr><code>M2-VR-04</code></nobr> | <nobr><code>M2-PB-04</code></nobr> |
...
| <nobr><code>M2-VR-02</code></nobr> | <nobr><code>M2-REQ-02</code></nobr> | Every rebuilt MIL training input matches its historical keys, perturbation order, gene order, shape, dtype, and values, and the loader reports the selected bag and conditioning rules. | [test_rebuilds_selected_mil_inputs](../../mantra/src/mantra/rebuild/tests/test_mil_inputs.py) | [test_rejects_changed_mil_input_or_bag](../../mantra/src/mantra/rebuild/tests/test_mil_inputs.py) |
| <nobr><code>M2-VR-03</code></nobr> | <nobr><code>M2-REQ-03</code></nobr> | The approved MIL configuration reproduces the teacher and student arrays, checkpoints, selection records, and fixed MIL identity contract without loading hold targets during selection. | [test_rebuilds_selected_teacher_and_student](../../mantra/src/mantra/rebuild/tests/test_mil_training.py) | [test_rejects_changed_training_intermediate_or_hold_selection](../../mantra/src/mantra/rebuild/tests/test_mil_training.py) |
| <nobr><code>M2-VR-04</code></nobr> | <nobr><code>M2-REQ-04</code></nobr> | The Step02 output arrays and weight arrays equal their retained historical counterparts and the hold PearsonDelta equals 0.5924883417873266. | [test_rebuilds_selected_step02](../../mantra/src/mantra/rebuild/tests/test_mil_reconstruction.py) | [test_rejects_changed_step02_output](../../mantra/src/mantra/rebuild/tests/test_mil_reconstruction.py) |
| <nobr><code>M2-VR-05</code></nobr> | <nobr><code>M2-REQ-05</code></nobr> | The Step03 output arrays and weight arrays equal their retained historical counterparts and the final hold PearsonDelta equals 0.6025499488874759. | [test_rebuilds_selected_step03](../../mantra/src/mantra/rebuild/tests/test_mil_reconstruction.py) | [test_rejects_equal_score_with_changed_step03_output](../../mantra/src/mantra/rebuild/tests/test_mil_reconstruction.py) |
