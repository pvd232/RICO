...
| `P0-PB-05J` | Pending | Drafting | None | [Block](../contracts/mantra-rebuild-phase-0.md#p0-pb-05j) | [Source and tests](../contracts/mantra-rebuild-phase-0.md#p0-pb-05j-proposed-code) |
...
- [ ] Permit a caller to approve prior-run source repositories for loader
